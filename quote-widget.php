...
__('Quote Widget', 'wpb_widget_domain'), 

// Widget description
array( 'description' => __( 'Get a Quote widget in your site', 'wpb_widget_domain' ), ) 
);
}
...
$title = __( 'Your Quote Widget Title', 'wpb_widget_domain' );
}
// Widget admin form
?>
<p>
